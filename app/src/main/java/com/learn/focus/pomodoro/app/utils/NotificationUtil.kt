...
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            nBuilder.setContentTitle("Таймер завершился.")
                .setContentText("Запустить сначала?")
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Таймер запущен.")
                .setContentText("Окончание: ${df.format(Date(wakeUpTime))}")
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
        ...
        fun showTimerPaused(context: Context) {
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Таймер приостановлен")
                .setContentText("Продолжить?")
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic_play, "Продолжить", resumePendingIntent)
